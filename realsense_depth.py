...
This class is for the start-up of the camera and activation for detecting the distance of
every object in the produced image. Produces RGB image (for vision) and infrared image (for distance and rotary detection).
It overlaps the two images so that [x, y, z] can be obtained simultaneously. Given by Intel.
"""
